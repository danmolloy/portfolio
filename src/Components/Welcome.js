...
export const Welcome = () => {
  return (
    <div className="welcome flex flex-col items-center justify-center">
      <img src={WelcomePic} alt="Dan in a garden" className="max-h-screen-sm max-w-screen-sm md:self-end md:mr-20"/>
      <div className="absolute sm:-mt-96 text-center text-white lg:text-black md:left-20">
